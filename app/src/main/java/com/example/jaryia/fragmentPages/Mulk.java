 ...
 * Use the {@link Mulk#newInstance} factory method to
...
public class Mulk extends Fragment {
    ...
    public static Mulk newInstance(String param1, String param2) {
        Mulk fragment = new Mulk();
                ...
                if (!response.isSuccessful()) {
                    ...
                    if (postInfos != null) {
                        ...
                        for (int i = 0; i < postInfos.size(); i++) {
                            if (postInfos.get(i).getItemchoice() == 1) {
