 ...
 * Use the {@link BuySellHome#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BuySellHome extends Fragment {
     ...
     * @return A new instance of fragment BuySellHome.
     */
    // TODO: Rename and change types and number of parameters
    public static BuySellHome newInstance(String param1, String param2) {
        BuySellHome fragment = new BuySellHome();
                ...
                if (!response.isSuccessful()) {
                    ...
                    if (postInfos != null) {
                        ...
                        for (int i = 0; i < postInfos.size(); i++) {
                            if (postInfos.get(i).getItemchoice() == 4) {
